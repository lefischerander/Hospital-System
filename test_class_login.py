...
class AuthSystem:
    def __init__(self):
        self.users = {
            'K.Kolbek': Admin('K.Kolbek', '3eb3fe66b31e3b4d10fa70b5cad49c7112294af6ae4e476a1c405155d45aa121'), # admin123
    ...
    def login(self, username, password):
        ...
        if username not in self.users:
            ...
            if user_role == 'doctor':
                ...
                print(f"Your department: {self.users[username].department}\n")
            else:
                print(f"You are {user_role} in this hospital\n")
    ...
    def logout(self, username):
        if username in self.logged_in_users:
            ...
            print(f"User {username} logged out seccesful. Thank you for using our services.")
            sys.exit()
        else:
